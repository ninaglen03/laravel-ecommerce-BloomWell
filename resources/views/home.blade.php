...
@section('hero')
    <section class="hero-banner">
        <div class="container hero-inner text-center text-md-left">
            <p class="hero-kicker mb-3">Modern apothecary</p>
            <h1 class="hero-title mb-3">Nature-forward formulas crafted for everyday balance</h1>
            <p class="hero-subtext mb-4">From adaptogenic tonics to mineral-rich skincare, every BloomWell product is sourced sustainably and blended to help you feel grounded, glowing, and well-rested.</p>
            <div class="hero-actions d-flex flex-column flex-md-row justify-content-center justify-content-md-start align-items-center">
                <a href="{{ route('shop.index') }}" class="btn btn-wellness mb-3 mb-md-0">Shop the apothecary</a>
                <a href="{{ route('register') }}" class="btn btn-ghost">Join Bloom Club</a>
            </div>
...
@section('content')
    <div class="home-grid mt-4">
        ...
        <section class="collection-grid">
            <article class="collection-card" style="background-image:linear-gradient(135deg, rgba(12,41,32,.2), rgba(12,41,32,.7)), url('https://www.divasenergy.shop/cdn/shop/products/Divascalmingkit30_3806x.jpg?v=1631055470'); background-size:cover; background-position:center;">
                ...
                <a href="{{ route('shop.index') }}" class="btn btn-light btn-sm font-weight-bold px-3">Browse blends</a>
            </article>
            <article class="collection-card" style="background-image:linear-gradient(135deg, rgba(31,77,58,.15), rgba(10,10,10,.65)), url('https://www.sacredbodyrituals.com/cdn/shop/products/IMG_8199_540x.heic?v=1682851746'); background-size:cover; background-position:center;">
                ...
                <a href="{{ route('shop.index') }}" class="btn btn-light btn-sm font-weight-bold px-3">See skincare</a>
            </article>
            <article class="collection-card" style="background-image:linear-gradient(135deg, rgba(31,77,58,.25), rgba(31,77,58,.8)), url('https://maxwellclinic.com/wp-content/uploads/2021/01/Updated-Pantry-Image.png'); background-size:cover; background-position:center;">
                ...
                <a href="{{ route('shop.index') }}" class="btn btn-light btn-sm font-weight-bold px-3">Stock the shelf</a>
            </article>
        </section>
        ...
        <section id="rituals" class="row">
            <div class="col-md-6 mb-4">
                <div class="ritual-card">
                    ...
                    <a href="{{ route('shop.index') }}" class="btn btn-link p-0 text-forest font-weight-bold">Add sunrise set</a>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="ritual-card">
                    ...
                    <a href="{{ route('shop.index') }}" class="btn btn-link p-0 text-forest font-weight-bold">Shop evening kit</a>
                </div>
            </div>
        </section>

        <section class="testimonial-cta position-relative text-center text-md-left">
            <div class="row align-items-center">
                ...
                <div class="col-md-5 text-md-right mt-4 mt-md-0">
                    <a href="{{ route('register') }}" class="btn btn-wellness mb-3">Book a 1:1 consultation</a>
